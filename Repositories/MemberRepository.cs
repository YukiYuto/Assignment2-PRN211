...
namespace Repositories
{
    public class MemberRepository : IMemberRepository
    {
        ...
        public Customer? GetCustomer(int id) =>MemberDAO.Instance.GetCustomer(id);
        

        public ICollection<Customer> GetCustomers(int id) => MemberDAO.Instance.GetCustomersById(id);
