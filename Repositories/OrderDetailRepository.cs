...
namespace Repositories
{
    public class OrderDetailRepository : IOrderDetailRepository
    {
        ...
        public OrderDetail? GetOrderDetail(int orderId, int flowerBouquetId) => OrderDetailDAO.Instance.GetOrderDetail(orderId, flowerBouquetId);


        public ICollection<OrderDetail> GetOrderDetails() => OrderDetailDAO.Instance.GetOrderDetailById(orderId, flowerBouquetId);
